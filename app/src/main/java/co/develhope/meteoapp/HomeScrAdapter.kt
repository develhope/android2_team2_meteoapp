...
class HomeScrAdapter(private val frameList: ArrayList<SummaryForecast>,val listener: HomeScreenListener): RecyclerView.Adapter<HomeScrAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            listener.itemClick(currentItem)
        }
...
interface HomeScreenListener{
    fun itemClick(item: SummaryForecast)
}